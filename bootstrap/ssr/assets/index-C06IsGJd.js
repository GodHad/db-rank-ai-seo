...
import { useToast, useColorModeValue, Text, Box, Link, Icon, Flex, Button, Table, Thead, Tr, Th, Tbody, Td, Tooltip, IconButton, NumberInput, NumberInputField, NumberInputStepper, NumberIncrementStepper, NumberDecrementStepper, Select } from "@chakra-ui/react";
...
import EncyclopediaForm from "./EncyclopediaForm-Cf0nnKcV.js";
import { useQueryClient, useQuery, useMutation } from "react-query";
import { g as getEncyclopedias, d as deleteEncyclopedia } from "./use-request-DzdpIW3X.js";
      ...
      cell: (info) => /* @__PURE__ */ jsxs(Fragment, { children: [
        /* @__PURE__ */ jsx(
          Link,
          {
            ...
            p: "0px !important",
            onClick: () => {
              setEncyclopedia(info.row.original);
              setOpenedPage(1);
            },
  ...
  return /* @__PURE__ */ jsx(Dashboard, { children: /* @__PURE__ */ jsx(Box, { pt: { base: "130px", md: "80px", xl: "80px" }, children: /* @__PURE__ */ jsxs(
    Card,
    {
      ...
      children: [
        openedPage === 0 && /* @__PURE__ */ jsxs(Fragment, { children: [
          /* @__PURE__ */ jsx(Flex, { w: "100%", children: /* @__PURE__ */ jsxs(
            Button,
            {
              ...
              onClick: () => {
                setOpenedPage(1);
                setEncyclopedia(initialEncyclopedia);
              },
              children: [
        ...
        openedPage === 1 && /* @__PURE__ */ jsx(EncyclopediaForm, { encyclopedia, setOpenedPage: () => {
          setOpenedPage(0);
        } })
      ]
    }
