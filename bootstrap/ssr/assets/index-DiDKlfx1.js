...
import { useToast, useColorModeValue, Text, Link, Icon, Box, Flex, Button, Table, Thead, Tr, Th, Tbody, Td, Tooltip, IconButton, NumberInput, NumberInputField, NumberInputStepper, NumberIncrementStepper, NumberDecrementStepper, Select } from "@chakra-ui/react";
import { MdEdit, MdDelete, MdAdd, MdArrowLeft, MdChevronLeft, MdChevronRight, MdArrowRight } from "react-icons/md";
...
import BannerForm from "./BannerForm-Cxp4P6cn.js";
import { useQueryClient, useQuery, useMutation } from "react-query";
import { g as getBanners, d as deleteBanner } from "./use-request-CXEg0apC.js";
...
function Banner() {
  ...
  const columns = [
    ...
    columnHelper.accessor("type", {
      ...
      cell: (info) => /* @__PURE__ */ jsx(Text, { color: textColor, fontSize: "sm", fontWeight: "700", _hover: { color: "blue.500" }, children: info.getValue() === 0 ? "Top Banner" : "Bottom Banner" })
    }),
    columnHelper.accessor("link", {
      ...
      cell: (info) => /* @__PURE__ */ jsx("a", { href: info.getValue(), target: "_blank", children: /* @__PURE__ */ jsx(Text, { color: textColor, fontSize: "sm", fontWeight: "700", children: info.getValue() }) })
    }),
  ...
  return /* @__PURE__ */ jsx(Dashboard, { children: /* @__PURE__ */ jsx(Box, { pt: { base: "130px", md: "80px", xl: "80px" }, children: /* @__PURE__ */ jsxs(
    Card,
    {
      ...
      children: [
        ...
        openedPage === 1 && /* @__PURE__ */ jsx(BannerForm, { banner, setOpenedPage: () => {
          setOpenedPage(0);
        } })
      ]
    }
