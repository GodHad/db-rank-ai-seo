...
import FeaturedProductForm from "./FeaturedProductForm-CPJZLhYH.js";
...
function FeaturedProduct() {
  ...
  const { data: featured_products, isLoadingSponsors } = useQuery("top_featured_products", () => getFeaturedProducts("top"));
