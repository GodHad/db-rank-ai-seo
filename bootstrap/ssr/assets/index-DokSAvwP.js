...
function Services({ content }) {
  ...
  return /* @__PURE__ */ jsxs(UserLayout, { children: [
    /* @__PURE__ */ jsx(SeoHeader, { content, title: "Services" }),
    /* @__PURE__ */ jsx(
      Card,
      {
        w: "100%",
        ...
        children: /* @__PURE__ */ jsxs(Box, { width: "100%", px: "25px", children: [
          /* @__PURE__ */ jsxs(Breadcrumb, { children: [
            ...
            /* @__PURE__ */ jsx(BreadcrumbItem, { color: secondaryText, fontSize: "sm", mb: "5px", children: /* @__PURE__ */ jsx(Link, { href: "/services", children: "Services" }) })
          ] }),
          /* @__PURE__ */ jsx(
            Text,
            {
