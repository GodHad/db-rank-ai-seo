                    ...
                    <>
                        ...
                        {content.meta_description && (
                            <>
                                ...
                                <meta property="og:image:alt" content={content.meta_description} />
                            </>
                        )}
                        {content.twitter_graph_image && <meta name="twitter:image" content={`${APP_URL}storage/${content.twitter_graph_image}`} />}
                        {content.og_graph_image && <meta property="og:image" content={`${APP_URL}storage/${content.og_graph_image}`} />}
                    </>
                )}
            </InertiaHead>
        </>
